...
<div id="menu-bar">
	<a href="option-patient-form.php"><button id="formulario-paciente">Formulário de Pacientes</button></a>
	<a href="option-patient-list.php"><button id="paciente-cadastrado">Pacientes Cadastrados</button></a>
	<a href="option-doctor-form.php"><button id="cadastrar-medico">Cadastrar Novo Médico</button></a>
...
<?php
	...
	switch($_SESSION["alert"])
	{
		...
		case 6:
			echo '<script language="javascript">
			document.getElementById("alert").setAttribute("style","opacity: 1; background-color: tomato;");
			document.getElementById("alert-mensage").innerHTML="CPF não encontrado na Base de Dados...";
			setTimeout(function(){ document.getElementById("alert").setAttribute("style","opacity: 0;"); }, 7000);
		</script>';
			break;
		case 7:
